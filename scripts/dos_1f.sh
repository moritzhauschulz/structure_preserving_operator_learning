...
for factor in 24.7812; do
    python main.py --problem 1d_wave --device cpu --method deeponet \
            --load_checkpoint /Users/moritzhauschulz/oxford_code/structure_preserving_operator_learning/methods/deeponet/experiments/dos_1e_2/exp_n_20250420-094330/models/best_ckpt_epoch_100.pth \
            --eval_only True \
