...
for strat in FourierNorm Fourier; do
    python main.py --problem 1d_wave --device cpu --method deeponet \
            ...
            --load_checkpoint /Users/moritzhauschulz/oxford_code/structure_preserving_operator_learning/methods/deeponet/experiments/ex32_1/exp_n_20250317-145316/models/best_ckpt_epoch_985.pth \
            --fourier_input True \
            --num_input_fn 2 \
            --num_output_fn 1 \
            --col_N 199 \
